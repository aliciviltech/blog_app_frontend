    ...
    return (
        <>
            ...
            <div>
                ...
                {
                    nestedRoute == '/user-dashboard' && activeUserRedux._id &&
                    <h1 className='text-center mt-20 text-2xl sm:text-4xl font-sans '>Welcome to {activeUserRedux.name} dashboard</h1>
